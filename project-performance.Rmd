...
# plot the relationship between Prate (Type of rate was calculated for the institution) and the Default Rate (Bar Graph)
default_rates %>% 
ggplot() + 
...
# plot the relationship between Prate (Type of rate was calculated for the institution) and the Default Rate (Box Plot)
default_rates %>% 
